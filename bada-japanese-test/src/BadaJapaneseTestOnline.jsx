            ...
            <div className="space-y-4">
              {currentQ.options.map((option, idx) => (
                <button
                  ...
                  className="w-full text-left p-5 border-3 border-blue-200 rounded-xl hover:border-blue-400 hover:bg-blue-50 transition duration-200 text-lg"
                >
                  <span className="font-bold text-blue-600 mr-4">{idx + 1}.</span>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          <div>
                            ...
                            <span className="text-gray-700">{q.options[answer.selected]}</span>
                          </div>
                          <div>
                            <span className="text-sm text-green-600 font-semibold">正解: </span>
                            <span className="text-gray-700 font-bold">{q.options[q.correct]}</span>
                          </div>
                        </div>
                      </div>
                    </div>
